            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 mt-10'>
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className='w-full ml-5'>
                        <h1 className="text-3xl font-bold">Microblading</h1>
                        <p className="py-5 text-sm">
                            Microblading creates perfectly shaped, natural-looking eyebrows, enhancing your facial features and boosting confidence. This semi-permanent treatment offers long-lasting, effortless beauty, giving you well-defined, attractive brows that frame your face beautifully. Enjoy the convenience and confidence of flawless eyebrows without the daily hassle of makeup.
                        </p>
                        <div className='w-full flex gap-3'>
                            ...
                            <p className='text-sm'><span className='text-slate-400'>340 Reviews</span> & <span className='text-slate-400'>249 Ratings</span></p>
                        </div>

                        <div className='w-full flex items-center gap-3 my-3'>
                            <h1 className='text-2xl font-bold'>₹ 10,000</h1>
                            <h2 className='text-slate-400 text-xl line-through'>₹ 13,000</h2>
