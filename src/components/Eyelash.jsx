            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 mt-10'>
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className='w-full ml-5'>
                        <h1 className="text-3xl font-bold">Eyelash</h1>
                        <p className="py-5 text-sm">
                        Beautiful eyelashes enhance the allure of your eyes by adding depth and definition. They create a captivating, expressive look that boosts confidence and elevates your overall appearance. With lush, well-defined lashes, you can achieve an eye-catching and mesmerizing effect that leaves a lasting impression.
                        </p>
                        ...
                        <div className='w-full flex items-center gap-3 my-3'>
                            ...
                            <h2 className='text-slate-400 text-xl line-through'>₹ 3,900</h2>
