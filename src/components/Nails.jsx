...
import Nail from '../../src/assests/Nail.png';
            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 mt-10'>
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className='w-full ml-5'>
                        <h1 className="text-3xl font-bold">Nails</h1>
                        <p className="py-5 text-sm">
                            Well-groomed nails add elegance and style, enhancing your overall appearance with a polished, professional look. They boost confidence by reflecting personal care and attention to detail. Beautifully maintained nails complete your look, making a strong, positive impression in both personal and professional settings.
                        </p>
                        ...
                        <div className='w-full flex items-center gap-3 my-3'>
                            ...
                            <h2 className='text-slate-400 text-xl line-through'>₹ 1,300</h2>
