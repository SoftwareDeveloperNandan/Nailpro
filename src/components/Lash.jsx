            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 mt-10'>
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className='w-full ml-5'>
                        <h1 className="text-3xl font-bold">Lash Linting</h1>
                        <p className="py-5 text-sm">
                            Lash tinting adds depth and definition to your lashes, providing a fuller, darker look that enhances your eyes effortlessly. This treatment simplifies your beauty routine, giving your lashes a naturally bold appearance without the need for mascara. Enjoy the convenience and confidence of beautifully tinted lashes that highlight your eyes.
                        </p>
